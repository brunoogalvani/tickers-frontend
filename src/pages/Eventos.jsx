...
export default function Eventos() {
    ...
    async function deleteEvento(eventoId) {
        if (eventoId) {
            ...
            Swal.fire('Evento excluído com sucesso!', '', 'success')         
            } catch (error) {
                Swal.fire('Erro ao excluir evento', '', 'error')
            }
        }
    }
    ...
    return (
        <div className="min-h-screen text-white flex flex-col items-center justify-center bg-[radial-gradient(circle_at_center,_#1a1a2e,_#16213e)]">
            <div className="flex flex-col items-center gap-6 p-8 rounded-2xl shadow-lg bg-white/10 backdrop-blur-lg border border-white/20">
